...
export default function ConnectButton() {
  return (
    // check https://docs.family.co/connectkit/connect-button#connect-button for more about custom button parameters
        ...
        return (
          ...
          >
            ...
            <div className="flex whitespace-nowrap">
              <span className="text-white">{isConnected ? ensName ?? truncatedAddress : "Connect Wallet"}</span>
            </div>
          </button>
        );
      }}
